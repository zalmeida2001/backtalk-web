              ...
              <div className="row" style={{ height: '90vh' }}>
                ...
                <div className="col-md-9 messages-margin-top">
                  <div className="h-100 mr-1 d-flex flex-column shadow-lg">
                    <h5 className="card-header border bg-header">
                      {otherUser}
                    </h5>
                    <div className="card-body h-100 d-flex flex-column align-items-start justify-content-end px-3 border-right border-left bg-light">
                    ...
                    <div className="card-footer border input-group bg-header">
                      <input
                        disabled={isDisabled}
